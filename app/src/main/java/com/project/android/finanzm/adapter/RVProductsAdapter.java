...
public class RVProductsAdapter extends RecyclerView.Adapter<RVProductsAdapter.CategoriesViewHolder> {
    private final List<Product> items;
    private final Context mContext ;

    private CategoriesViewHolder.OnGridItemsListener onGridItemsListener;

    public RVProductsAdapter(List<Product> items, Context context, CategoriesViewHolder.OnGridItemsListener onGridItemsListener){
        this.items = items;
        mContext = context;
    ...
    public void onBindViewHolder(@NonNull CategoriesViewHolder categoriesViewHolder, int i) {
        ...
        Log.i("ProductAdapter", "" + items.get(i).getArticleCode());
        categoriesViewHolder.categoriesName.setText(items.get(i).getDescription());
        categoriesViewHolder.categoriesPhoto.setImageResource(items.get(i).getImageRessources());
