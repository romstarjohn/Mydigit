...
import com.project.android.finanzm.adapter.SalesItemAdapter;
...
public class ReceiptFragment extends Fragment {
    ...
    private SalesItemAdapter mAdapter;
    ...
    protected void initViewModel() {
        final Observer<List<Product>> receipt_observer = new Observer<List<Product>>() {
            ...
            public void onChanged(@Nullable List<Product> products) {
                ...
                Log.i("Receiptfragment", "Product is empty at ");
                    ...
                    mAdapter = new SalesItemAdapter(getActivity(), resID, mProduct);
        ...
        model = ViewModelProviders.of((FragmentActivity) getActivity()).get(ReceiptViewModel.class);

        model.getAllRingedArticles().observe(getViewLifeCycleOwner(), receipt_observer);
    }
